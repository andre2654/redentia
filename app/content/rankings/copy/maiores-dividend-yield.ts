 ...
 *
 * TICKER EM MAIÚSCULA (20/08/2026): os 19 hrefs deste arquivo estavam em
 * minúscula e /asset/{minúsculo} 301a pro maiúsculo. Eram 19 redirects
 * internos numa página só, gastando crawl budget e diluindo o sinal do
 * link. Ver "Página com redirecionamento: 1.073" no relatório de cobertura.
