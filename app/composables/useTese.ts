      ...
      studies: [
        {
          ...
          sources: [
            { title: 'Citi corta preços-alvo de CSN e CSN Mineração à espera de 2T26 misto', url: '#', meta: 'Notícia · Money Times' },
            { title: 'Ibovespa entra no modo Bolt e dispara após IPCA surpreender', url: '#', meta: 'Notícia · Seu Dinheiro' },
            { title: 'Tupy (TUPY3): XP vê ciclo de recuperação ganhar força e eleva para compra', url: '#', meta: 'Notícia · Money Times' },
            { title: 'Caterpillar to triple power generation capacity, raises 2030 targets', url: '#', meta: 'Relatório · Manufacturing Dive' },
            { title: 'Eaton Reports Record First Quarter 2026 Results, Raises Guidance to 10%', url: '#', meta: 'Documento · Eaton' },
            { title: 'AMD & OpenAI to Deploy 6GW of Instinct GPUs, With 1GW of MI450 in 2H 2026', url: '#', meta: 'Notícia · WCCFTech' },
            { title: 'Gerdau reshapes North American footprint as tariffs squeeze imports', url: '#', meta: 'Relatório · Steel Market Update' },
          ],
          rowDate: '11 jul',
        },
