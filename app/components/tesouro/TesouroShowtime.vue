  ...
  >
    ...
    <div class="relative mx-auto w-full max-w-6xl px-6 pb-10 pt-8 md:grid md:grid-cols-12 md:gap-10 md:px-10 md:pb-14 md:pt-12">
      ...
      <div class="relative md:col-span-7">
        ...
        >
          A grana segura<br />
          <span class="highlighter" :style="{ color: 'var(--brand-primary)' }">do tesouro!</span>
        </h1>

        <p class="font-showtime-body mt-5 max-w-xl text-base" :style="{ color: 'color-mix(in srgb, var(--brand-text) 80%, transparent)' }">
          O <strong :style="{ color: 'var(--brand-primary)' }">{{ paperName }}</strong> em linguagem de gente: quanto rende, quanto custa, quando vence. Sem letra miúda.
        </p>
        ...
        <div class="mt-8 flex flex-wrap items-baseline gap-x-5 gap-y-2">
          ...
          <span
            ...
            :style="{ color: 'var(--brand-text)', fontSize: 'clamp(2.5rem, 5vw, 4.5rem)' }"
          >
          ...
          <span
            ...
            :style="{
              backgroundColor: `${'var(--brand-primary)'}25`,
        ...
        >
          ...
          <dl class="mt-5 flex flex-col gap-3">
            ...
            <div v-if="data?.price_sell != null" class="flex items-center justify-between">
              ...
              <dd class="font-showtime-body tabular-nums text-sm font-bold" :style="{ color: 'var(--brand-positive)' }">
    ...
    <div class="relative py-20 md:py-28" :style="{ backgroundColor: 'var(--brand-surface)' }">
      <div class="mx-auto max-w-4xl px-6 text-center md:px-10">
        ...
        >
          Vale a pena pra<br />
          <span class="highlighter" :style="{ color: 'var(--brand-primary)' }">você?</span>
        </h2>
