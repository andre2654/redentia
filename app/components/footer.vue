<template>
  <div class="flex w-full flex-col" :style="{ backgroundColor: footerBg, color: brand.colors.text, borderTop: `1px solid ${brand.colors.border}` }">
    ...
    <div class="w-full py-12">
      <div class="mx-auto max-w-[1400px] px-4">
        <h2 class="mb-6 text-center text-2xl uppercase tracking-wide md:text-3xl" :style="{ color: brand.colors.text }">
          ...
          >
            ...
            >
              ...
              <span class="flex flex-col leading-tight">
                <span class="text-[10px] uppercase tracking-[0.14em]" :style="{ color: brand.colors.textMuted }">WhatsApp</span>
            ...
            >
              <span
                class="flex size-7 items-center justify-center rounded-full"
                :style="{ background: brand.colors.primary, color: brand.colors.background }"
                aria-hidden="true"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
              </span>
              <span class="flex flex-col leading-tight">
                <span class="text-[10px] uppercase tracking-[0.14em]" :style="{ color: brand.colors.textMuted }">Email</span>
