...
.status-chip--active .status-chip__dot--active { box-shadow: 0 0 0 3px rgba(16, 185, 129, 0.2); }
...
.vig-status-card[data-state='active'] .vig-status-card__badge {
  background: color-mix(in srgb, #10b981 18%, transparent); color: #34d399;
}
...
.vig-timeline__bar--expired { background: linear-gradient(90deg, transparent, #ef4444); opacity: 0.5; }
