...
// Orb de partículas do hero — porte 1:1 do <script data-dc-script> do design
// (superellipse rotacionando, 44 anéis × 104 pontos, composite 'lighter',
// fit com devicePixelRatio no resize, cleanup no unmount).
// EXCEÇÃO consciente à regra de tokens: canvas 2D não lê var(--nu-*), então as
// cores da pintura vivem aqui, idênticas às do design.
