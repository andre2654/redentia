...
>>(() => [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Maiores Valor de Mercado', to: '/ranking/maiores-valor-mercado' },
      { label: 'Mais Baratas (Graham)', to: '/ranking/mais-baratas-graham' },
      { label: 'Buy and Hold', to: '/ranking/buy-and-hold' },
      { label: 'Maiores ROEs', to: '/ranking/maiores-roe' },
      { label: 'Maior Potencial de Upside', to: '/ranking/maior-potencial-upside' },
