...
// Brand colors
const primaryColor = computed(() => brand.colors.primary || '#198ed6')
...
useHead(() => ({
  title: `${brand.name} - ${tickerA.value} vs ${tickerB.value}`,
  meta: [
    ...
    >
      ...
      <div class="header">
        <div class="header-left">
          <BrandLogo variant="icon" class="brand-icon" />
          <span class="brand-name">{{ brand.shortName.toUpperCase() }}</span>
        </div>
        <span class="header-label" :style="{ opacity: 0.8 }">{{ brand.domain.toUpperCase() }}</span>
      </div>
      ...
      <!-- Footer -->
      <div class="footer">
        <BrandLogo variant="full" class="footer-logo" />
        <div class="footer-brand">
          <BrandLogo variant="icon" class="footer-icon" />
          <span class="footer-text">{{ brand.domain }}</span>
        </div>
      </div>
    </div>
  </div>
