    ...
    >
      ...
      <template #hero>
        ...
        <div class="wp8-hero-ctas">
          ...
          <NuxtLink to="/wallet-preview/v8/resultado" class="wp8-result-btn">
    ...
    <section v-if="!loading && positionsReal.length" class="wp8-cta-fullbleed">
      ...
      <div class="wp8-cta-inner">
        <header class="wp8-cta-head">
          ...
          <NuxtLink to="/wallet-preview/v8/resultado" class="wp8-cta-primary">
            <span>Ver mais</span>
...
import type { WalletDividendEvent, WalletPosition } from '~/composables/useWalletMockData'
...
// Services reais — substituem o useWalletMockData() do preview.
// useWalletMockData ainda existe (nao deletamos imports) caso a gente
// queira voltar pra mock rapidao em algum cenario.
