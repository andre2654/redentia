      ...
      <form v-if="editing" class="flex flex-col gap-4 p-6" @submit.prevent="onSave">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          <label class="flex flex-col gap-2">
            ...
            <input v-model="editing.slug" type="text" required pattern="[a-z0-9_-]+" maxlength="60" class="rounded-sm border bg-transparent px-3 py-2 text-[13px] outline-none" :style="{ borderColor: C.border, color: C.text }" />
          </label>
          <label class="flex flex-col gap-2">
