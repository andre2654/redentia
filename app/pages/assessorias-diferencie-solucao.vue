...
const tenantPreviews = [
  {
    ...
    features: ['Hero radiograph + Score 0-100', 'Chat IA com método ARCA', 'Cobertura completa B3'],
  ...
  },
  {
    ...
    name: 'Me Poupe!',
    mark: 'MP',
    tag: 'TV pop magazine, Nathalia Arcuri',
    badgeLabel: 'Showtime',
    badgeKind: 'demo',
    bg: '#FFD93D',
    fg: '#1A0A2E',
    ...
    features: ['Lower-third "QUADRO" pulsando', 'Sticker badges + washi tape', 'Linguagem irreverente, criatura'],
  ...
  },
  {
    ...
    name: 'Primo Rico',
    mark: 'PR',
    tag: 'Book-cover masterclass, Thiago Nigro',
    badgeLabel: 'Mentor',
    badgeKind: 'preview',
    bg: '#000000',
    fg: '#FF5900',
    ...
    italic: false,
    iframeUrl: '/?brand=primo-rico',
    url: 'https://www.redentia.com.br/?brand=primo-rico',
    features: ['"Manual do Primo" capítulos editoriais', 'Ticker monumental + pull quote', 'Método ARCA aplicado'],
      ...
      <div class="lp-container">
        ...
        <div class="sol-what__grid">
          <article class="sol-what__card">
            <div class="sol-what__icon" :style="{ background: `color-mix(in srgb, var(--brand-primary) 14%, transparent)`, color: 'var(--brand-primary)' }">
      ...
      <div class="lp-container">
        ...
        <div class="sol-uses__grid">
          <article class="sol-uses__card">
            <div class="sol-uses__icon" :style="{ background: `color-mix(in srgb, var(--brand-primary) 14%, transparent)`, color: 'var(--brand-primary)' }">
