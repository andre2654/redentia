<template>
  <NuxtLayout name="static" title="Termos e políticas">
    <section class="flex flex-col gap-3 px-10">
      <h1><strong>Termos e políticas</strong></h1>
      <p>
      ...
      <p>
        Ao marcar a opção referente à concordância e aceitação destes Termos de
        Uso você está anuindo com todas as suas condições e com a Política de
        Privacidade. Caso não esteja de acordo, não será possível utilizar a
        Plataforma, pois a sua utilização precede a aceitação integral a estes
        Termos de Uso, assim como a Política de Privacidade.
      </p>

      <h2><strong>Definições</strong></h2>
      <ul class="list-decimal">
        <li>
          <strong>"Cadastro"</strong> – significa o cadastro do Usuário feito no
          Site para ter acesso aos Conteúdos da Carteira.
        </li>
        <li>
          <strong>"Chat"</strong> – significa o chat que se encontra na
          Plataforma para atendimento ao público.
        </li>
        <li>
          <strong>"Código de Defesa do Consumidor"</strong> – significa a Lei nº
          8.078, de 11 de setembro de 1990, conforme alterada.
        </li>
        <li>
          <strong>"Conta de Usuário"</strong> – significa a conta de Usuário
          criada após a realização do Cadastro.
        </li>
        <li>
          <strong>"Conteúdo da Carteira"</strong> – tem o significado que lhe é
          atribuído no item I.
        </li>
        <li>
          <strong>"Conteúdos Financeiros"</strong> – tem o significado que lhe é
          atribuído no item I.
        </li>
        <li>
        ...
        <li>
          <strong>"CPF/ME"</strong> - significa Cadastro da Pessoa Física do
          Ministério da Economia.
        </li>
        <li>
          <strong>"Dados Pessoais"</strong> – significa toda informação
          relacionada a pessoa natural identificada ou identificável, nos termos
          da LGPD.
        </li>
        <li>
          <strong>"Direito de Propriedade Intelectual"</strong> – tem o
          significado que lhe é atribuído no item VIII.
        </li>
        <li>
          <strong>"Leis Aplicáveis"</strong> - significa a LGPD e todas as leis,
          estatutos, normas e regulamentos promulgados por autoridade
          governamental.
        </li>
        <li>
          <strong>"Lei nº 9.609"</strong> – significa a Lei nº 9.609, de 19 de
          fevereiro de 1998, conforme alterada.
        </li>
        <li>
          <strong>"Lei nº 9.610"</strong> – significa a Lei nº 9.610, de 19 de
          fevereiro de 1998, conforme alterada.
        </li>
        <li>
          <strong>"LGPD"</strong> – significa a Lei nº 13.709, de 14 de agosto
        ...
        <li>
          ...
          diversos ambientes que o Usuário terá acesso após o Cadastro ou
        ...
        <li>
          <strong>"Termos de Uso"</strong> – significa estes Termos e Condições
          de Uso e Serviços.
        </li>
        <li>
          <strong>"Usuário"</strong> – significa toda pessoa física ou jurídica
          que acessa a Plataforma.
        </li>
      </ul>

      <h2><strong>Informações Preliminares</strong></h2>
      <p>
        <strong
      ...
      <p>
        VOCÊ RECONHECE QUE ANALISOU E ACEITOU OS TERMOS DE USO. LEIA-OS
        ATENTAMENTE POIS O USO DA PLATAFORMA SIGNIFICA QUE VOCÊ ACEITOU TODAS AS
      ...
      <ul class="list-decimal">
        <li>
          Consolida informações publicamente disponibilizadas pelo mercado
          financeiro e de capitais sobre empresas de capital aberto e fundos de
          investimentos ("Conteúdos Financeiros")
        </li>
        <li>
          Consolida informações sobre a própria carteira de investimentos do
          Usuário ("Conteúdos da Carteira")
        </li>
      </ul>
      <p>
      ...
      <h2><strong>II – Conteúdos Financeiros</strong></h2>
      <p>
        Na Plataforma, sem necessidade de realização de Cadastro, o Usuário terá
        acesso aos Conteúdos Financeiros, dentre os quais são contempladas, por
        exemplo, em relação a tesouro direto, empresas de capital aberto e a
        fundos de investimento, conforme o caso, informações e/ou dados sobre:
      </p>
      <ul class="list-decimal">
        <li>Preço de mercado</li>
        <li>
          Indicadores financeiros (preço sobre lucro, preço sobre valor
          patrimonial, preço sobre EBTIDA, dívida líquida sobre patrimônio
          líquido, margem bruta, ROE, ROIC, dentre outros)
        </li>
        <li>Preço do aluguel de ativos</li>
        <li>Datas e valores da distribuição de dividendos</li>
        <li>Posições acionárias relevantes da empresa</li>
        <li>Endividamento</li>
        <li>Demonstrações de resultado do exercício</li>
        <li>Fluxo de caixa</li>
        <li>Balanço patrimonial</li>
        <li>Comunicados públicos aos acionistas e quotistas</li>
      </ul>
      <p>
        Os Conteúdos Financeiros disponibilizados ao Usuário são obtidos a
        partir de relatórios públicos das empresas listadas, instituições
        oficiais de registro, controle e fiscalização dos valores mobiliários,
        periódicos e outras fontes confiáveis e comuns aos operadores do mercado
        de capitais.
      </p>
      <p>
      ...
      <h2><strong>III – Conteúdos da Carteira</strong></h2>
      <p>
        A partir da realização do Cadastro, o Usuário poderá ter acesso aos
        Conteúdos da Carteira. Nessa medida, o Usuário terá acesso, com base nas
        informações por ele fornecidas a conteúdos consolidados de sua carteira
        de investimento, o que inclui, por exemplo:
      </p>
      <ul class="list-decimal">
        <li>
          Diferentes formas de visualização (gráficos e textos) dos seus
          investimentos
        </li>
        <li>Rentabilidade de sua carteira</li>
        <li>Preço-médio de seus ativos</li>
      </ul>
      <p>
        Em resumo, é disponibilizado, por meio da Plataforma, formas de o
        Usuário melhor visualizar suas carteiras de investimentos, bem como seu
        desempenho. Os Conteúdos da Carteira poderão ser pagos ou gratuitos,
        conforme informações contidas no Site ou aplicativo.
      </p>
      <p>
        Para fins de inserção das informações sobre sua carteira de
      ...
      <p>
        ...
        com sua corretora, ele desde já concorda com o compartilhamento de seus
        dados de acesso à mesma, assim como os dados contidos, por exemplo:
      </p>
      <ul class="list-decimal">
        <li>Saldo de conta</li>
        <li>Posições de investimentos</li>
        <li>Movimentações financeiras e investimentos</li>
        <li>Perfil de investidor</li>
        <li>Transações</li>
      </ul>
      <p>
        Ao utilizar o CEI e o Novo Portal da B3 para atualização de sua
        carteira, o Usuário concorda que estará sujeito às limitações deste
        portal, que só resgata o histórico de transações do usuário de 18 meses,
        portanto deverá cadastrar manualmente todas as operações realizadas
        anteriormente, a fim de ter as informações relativas a sua carteira,
        como preço médio e rentabilidade, calculadas.
      </p>
      <p>
      ...
      <p>
        Para o acesso aos Conteúdos da Carteira, o Usuário deverá realizar o
        Cadastro. O Cadastro será feito pelo Usuário no Site, com o correto
        preenchimento da ficha de cadastro e fornecimento dos dados solicitados,
        bem como a escolha de uma senha que será utilizada para o login na
        Plataforma.
      </p>
      <p>
        Para facilitar, o Usuário poderá, a seu exclusivo critério, utilizar o
        mesmo cadastro de sua conta nos serviços da gmail, com o que, caso assim
        o faça, desde já concorda com o compartilhamento de conta para fins de
        acesso.
      </p>
      <p>
      ...
      <p>
        O Cadastro é individual e intransferível, assim como seu login e senha,
      ...
      <p>
        São fornecidas informações pelo Usuário no âmbito do Cadastro, tais
        como:
      </p>
      <ul class="list-decimal">
        <li>Nome completo</li>
        ...
        <li>
          Número do Cadastro da Pessoa Física do Ministério da Economia (CPF/ME)
          ao se realizar a conexão com o CEI e o Novo Portal de B3
        </li>
      </ul>
      <p>
      ...
      <h2><strong>VI – Renovação e Cancelamento</strong></h2>

      <h3><strong>Renovação Automática</strong></h3>
      <p>
      ...
      <p>
        Caso o Usuário tenha não tenha interesse na renovação, bastará entrar em
        contato nos demais canais de atendimento disponibilizados. Na renovação
        automática o valor a ser pago na renovação será de acordo com o preço de
      ...
      <h3><strong>Cancelamento pelo Usuário</strong></h3>
      <p>
      ...
      <ul class="list-decimal">
        ...
        <li>Juros de mora de 1% (um por cento) ao mês</li>
        <li>Correção monetária calculada com base na variação IGP-M</li>
      </ul>
      ...
      <ul class="list-decimal">
        ...
        <li>
          Está ciente de que é de sua exclusiva responsabilidade a devida
          contabilização dos investimentos e a inclusão das informações
          referentes aos investimentos em suas declarações anuais de imposto de
          renda
        </li>
        <li>
      ...
      <ul class="list-decimal">
        ...
        <li>
          Não criar ou utilizar mais do que 1 (um) perfil para utilizar a
          Plataforma
        </li>
        <li>
          Não utilizar identificação de um terceiro ou permitir que terceiros
        ...
        <li>
          Não interferir, de qualquer forma, no funcionamento da Plataforma
        </li>
        <li>
        ...
        <li>
          ...
          quaisquer informações a que tiver acesso
        </li>
        <li>Não disseminar vírus ou código de computador malicioso</li>
        <li>Não violar qualquer legislação nacional ou internacional</li>
        <li>Não praticar atos contrários à moral e aos bons costumes</li>
        <li>Respeitar a Política de Privacidade</li>
        <li>
          Se encarregar dos tributos que recaiam sobre os investimentos que
          integram a carteira do Usuário
        </li>
      </ul>
      ...
      <ul class="list-decimal">
        <li>
          ...
          lealdade em relação ao Usuário
        </li>
        <li>
          Atender às normas, políticas e regulamentações vigentes, referentes
          aos serviços prestados no âmbito da Plataforma
        </li>
        <li>Acatar ordens judiciais emitidas por autoridade competente</li>
        <li>
          Envidar os melhores esforços para prestação dos serviços previstos na
          Plataforma
        </li>
      </ul>
      ...
      <h2>
        <strong
          >XI – Isenção de Garantias e Limitações de Responsabilidade</strong
        >
      </h2>
      <p>
      ...
      <p>
        Os Conteúdos Financeiros não caracterizam serviço de consultoria ou
        aconselhamento de valores mobiliários e, portanto, não implicam em
        recomendações de qualquer espécie, principalmente quanto à indicação de
        investimento, rentabilidade, adequação ou risco de um produto.
      </p>

      <h2><strong>XII – Propriedade Intelectual</strong></h2>
      <p>
      ...
      <ul class="list-decimal">
        ...
        <li>Fotos</li>
        <li>Ilustrações</li>
        <li>Marcas comerciais</li>
        <li>Nomes comerciais</li>
        <li>Marcas de serviço</li>
        <li>Logotipos</li>
        <li>Informações</li>
        <li>Código-fonte</li>
        <li>Layouts</li>
      ...
      <h2><strong>XIV – Disposições Gerais</strong></h2>
      <ul class="list-decimal">
        <li>
          O Usuário não poderá ceder ou transferir a qualquer terceiro, total ou
          parcialmente, seus direitos e obrigações decorrentes destes Termos de
          Uso
        </li>
        <li>
        ...
        <li>
          ...
          o único competente para dirimir quaisquer controvérsias decorrentes
          deste instrumento
        </li>
      </ul>
    </section>
