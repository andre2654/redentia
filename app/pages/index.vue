            ...
            <ul v-if="list.items.length" class="flex flex-col gap-3">
              ...
              >
                <NuxtLink
                  ...
                  :class="hasLeaderSpark(list.key, idx) ? '-mx-2 rounded-lg px-2 py-2' : ''"
                  :style="hasLeaderSpark(list.key, idx) ? { backgroundColor: 'color-mix(in srgb, var(--text-heading) 3%, transparent)' } : undefined"
                >
