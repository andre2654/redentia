      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            strategy: { type: 'string', enum: ['rentabilidade', 'seguranca'], description: 'Investment strategy' },
          },
      ...
      messages: [
        {
          ...
          3. If the user asks for information about an asset (price, chart, dividends, general info), use 'view_market_data'.
          4. If the user just wants to chat or asks general questions without a specific intent or asset, do NOT call any tool.
          5. If the user mentions a company name, convert it to the most likely B3 ticker (e.g. Petrobras -> PETR4, Vale -> VALE3).
          6. IMPORTANT: If the user provides numbers (money, time) and a ticker, it is almost certainly a simulation request.
